...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{setup1.jpeg}
        \caption{Vista general del espacio de captura.}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{setup.jpeg}
        \caption{Posición relativa entre sujeto y cámara.}
    \end{subfigure}
    \caption{Protocolo de captura de imágenes reales.}
...
\midrule
img\_014.jpg & Descartada por gesto diferente & 2026-04-17 \\
img\_027.jpg & Descartada por gesto diferente & 2026-04-17 \\
img\_043.jpg & Descartada por gesto diferente & 2026-04-17 \\
\bottomrule
\end{tabular}
\end{table}
